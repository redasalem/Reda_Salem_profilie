...
class ChatBot {
 ...
 getBotResponse(message) {
  ...
  const keywordsMap = [
    ...
    {
      keywords: ['hi', 'hello', 'hey', 'مرحبا', 'اهلا', 'ازيك', 'كيفك', 'كيف حالك','كيفك يا رضا','ازيك'],
      replies: [
    ...
    {
  keywords: ['مين رضا', 'مين رضا سالم', 'who is reda', 'about reda', 'مين انت', 'who are you','انت مين','من تكون'],
  replies: [
